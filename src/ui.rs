...
pub fn draw_ui(
    ...
    let footer_text = match (selected_tab, app_mode) {
        ...
        (2, _) if under_tauri      => " Q:Quit  Tab:Switch  ↑↓:Select  N:New  E:Edit  T:Thesis  ?:Guide (CC/SPV/SCV/IC/IFly/CCAL/PCAL/STR/BWB/CBWB/JL/PBF/CBF/LCV/LPV/PMCC/LDS/SDS/RS/PZBR/CZBR/SNP) ",
